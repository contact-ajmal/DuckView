...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-187%20passing-22c55e" alt="187 tests">
</p>
...
| 🧩 **Mosaic dashboards** | Declarative, cross-filtered dashboards from a YAML/JSON spec: editor with live preview, generated from any table or file in one click, shared with the workspace. Any table, file or query is a dataset. |
