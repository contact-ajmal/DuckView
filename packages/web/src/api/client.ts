...
export interface CopilotConfig { enabled: boolean; allow_byok: boolean; server_provider: CopilotProvider | null; server_model: string | null; server_source: 'settings' | 'config' | null; has_server_key: boolean; server_key_hint: string | null; server_base_url: string | null; server_aws: { region: string | null; agent_id: string | null; agent_alias_id: string | null; runtime_arn: string | null } | null; aws_providers: CopilotProvider[]; providers: CopilotProviderPreset[]; default_models: Record<string, string>; suggested_models: Record<string, string[]>; can_manage: boolean; can_use: boolean }
export interface CopilotServerSettings { provider: CopilotProvider; model: string | null; base_url: string | null; has_key: boolean; key_hint: string | null; aws_region: string | null; bedrock_agent_id: string | null; bedrock_agent_alias_id: string | null; agentcore_runtime_arn: string | null; updated_by_email: string | null; updated_at: string }
