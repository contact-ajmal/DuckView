...
export interface DataApp { id: string; workspace_id: string; user_id: string; name: string; description: string | null; kind: 'streamlit'; execution: 'server' | 'browser'; entry: string; files: Record<string, string>; spec: Record<string, unknown> | null; visibility: 'workspace' | 'org'; status: AppStatus; port: number | null; last_error: string | null; last_started_at: string | null; last_used_at: string | null; created_at: string; updated_at: string; url: string; source_bytes: number; running: boolean; always_on: boolean; runtime: 'subprocess' | 'docker' | 'kubernetes' | null; runtime_ref: string | null; publish_status: AppPublishStatus; publish_note: string | null; publish_requested_by: string | null; publish_requested_at: string | null; publish_reviewed_by: string | null; publish_reviewed_at: string | null }
/**
