...
export type ReverseDestination = { kind: 'database'; connection_id: string; schema?: string | null; table: string } | { kind: 'file'; format: 'parquet' | 'csv' | 'json'; path: string; cloud_connection_id?: string | null; bucket?: string | null } | { kind: 'http'; url: string; batch_size?: number; payload?: 'array' | 'object' | 'ndjson' };
