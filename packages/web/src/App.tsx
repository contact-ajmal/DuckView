...
type Route = 'overview' | 'query' | 'dashboards' | 'apps' | 'transform' | 'alerts' | 'governance' | 'connections' | 'settings' | 'mcp';
const ROUTES: { id: Route; hash: string; label: string }[] = [
  ...
  { id: 'transform', hash: '#/transform', label: 'Transform' },
...
function parseRoute(): Route {
  ...
  if (h.startsWith('transform')) return 'transform';
    ...
    <div className="flex h-full flex-col">
      <header className="flex h-14 shrink-0 items-center gap-5 border-b border-zinc-800 bg-zinc-950 px-5">
        ...
        <div className="ml-auto flex items-center gap-3">
          <ThemeMenu />
          <LayoutMenu currentPage={route === 'dashboards' || route === 'connections' || route === 'apps' || route === 'alerts' || route === 'governance' || route === 'transform' ? null : route} />
