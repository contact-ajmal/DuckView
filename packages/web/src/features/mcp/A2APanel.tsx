...
const MD = 'text-[13px] leading-relaxed text-zinc-300 [&_h2]:mt-2 [&_h2]:font-semibold [&_li]:ml-4 [&_li]:list-disc [&_p]:my-1.5 [&_code]:rounded [&_code]:bg-zinc-800 [&_code]:px-1 [&_code]:font-mono [&_code]:text-[11px] [&_td]:border [&_td]:border-zinc-800 [&_td]:px-2 [&_th]:border [&_th]:border-zinc-800 [&_th]:px-2';
    ...
    <div className="space-y-6 text-xs" data-testid="a2a">
      ...
      <section className="space-y-2">
        <div className="flex items-center gap-2">
          <h2 className="text-[13px] font-semibold text-zinc-100">Other agents can call yours</h2>
      ...
      <section className="space-y-2">
        <div className="flex items-center gap-2">
          <h2 className="text-[13px] font-semibold text-zinc-100">Agents you can ask</h2>
                ...
                <div key={r.id} className="space-y-2 rounded-md border border-zinc-800 p-3" data-remote={r.name}>
                  <div className="flex items-start gap-2">
                    <div className="min-w-0 flex-1">
                      <div className="text-[13px] font-medium text-zinc-100">{r.name}</div>
