    ...
    <div className="space-y-4 text-xs">
      ...
      {isAdmin && (
        <section className="space-y-2">
          ...
          {sinks.length === 0 ? <p className="rounded-lg border border-dashed border-zinc-800 p-4 text-zinc-500">No destinations — the audit log stays in DuckView (below, and in its database).</p> : (
      ...
      <section>
        <h3 className="mb-1.5 text-[11px] font-semibold uppercase tracking-wide text-zinc-500">{isAdmin ? 'Recent events' : 'Your recent activity'}</h3>
