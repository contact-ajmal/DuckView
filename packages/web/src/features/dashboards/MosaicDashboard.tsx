...
export function MosaicDashboard({ id }: { id: string }) {
  ...
  const [render, setRender] = useState<SpecRenderStatus>({ state: 'idle', error: null, warnings: [], problems: [], sources: 0 });
