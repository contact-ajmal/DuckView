...
export const LAYOUT_COMPONENTS: LayoutComponent[] = [
  ...
  { id: 'mcp.stats', page: 'mcp', label: 'Stats row', description: 'Agents, sessions, tokens, activity, safety' },
  { id: 'mcp.agents', page: 'mcp', label: 'Registered agents', description: 'Strands / LangGraph / CrewAI / AgentCore / Bedrock agents with their tokens' },
  { id: 'mcp.frameworks', page: 'mcp', label: 'Agent frameworks', description: 'Integration snippets per framework + OpenAPI download' },
