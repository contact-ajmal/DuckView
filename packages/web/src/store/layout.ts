...
export const LAYOUT_COMPONENTS: LayoutComponent[] = [
  ...
  { id: 'settings.sidebar', page: 'settings', label: 'Resources side bar', description: 'Live resources and detected hardware' },
  ...
  { id: 'settings.engine', page: 'settings', label: 'Engine settings', description: 'Memory, threads, timeout, extensions' },
  { id: 'settings.cloud', page: 'settings', label: 'Cloud storage', description: 'S3 / R2 / GCS / Azure connections' },
  { id: 'settings.connections', page: 'settings', label: 'Data connections', description: 'MotherDuck / Postgres / HTTP secrets' },
  { id: 'settings.account', page: 'settings', label: 'Account', description: 'Password and identity' },
  { id: 'settings.users', page: 'settings', label: 'Users', description: 'User management (admins)' },
