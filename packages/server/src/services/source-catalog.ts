...
export const SOURCE_CATALOG: SourceType[] = [
  ...
  { id: 'github', family: 'saas', label: 'GitHub', vendor: 'GitHub', blurb: 'Issues, pull requests, commits, releases, workflow runs and contributors of your repositories (GitHub Enterprise too).', backend: { family: 'connector', connector: 'github' }, auth: 'token', capabilities: { browse: true, attach: false, remote_sql: false, sync: true }, fields: [], status: 'available', docs: 'https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens' },
  { id: 'jira', family: 'saas', label: 'Jira', vendor: 'Atlassian', blurb: 'Issues of a project or any JQL, with every field (custom fields named as in Jira).', backend: { family: 'connector', connector: 'jira' }, auth: 'token', capabilities: { browse: true, attach: false, remote_sql: false, sync: true }, fields: [], status: 'available', docs: 'https://support.atlassian.com/atlassian-account/docs/manage-api-tokens-for-your-atlassian-account/' },
  { id: 'zendesk', family: 'saas', label: 'Zendesk', vendor: 'Zendesk', blurb: 'Tickets, users, organizations, groups and satisfaction ratings.', backend: { family: 'connector', connector: 'zendesk' }, auth: 'token', capabilities: { browse: true, attach: false, remote_sql: false, sync: true }, fields: [], status: 'available', docs: 'https://support.zendesk.com/hc/en-us/articles/4408889192858' },
  { id: 'shopify', family: 'saas', label: 'Shopify', vendor: 'Shopify', blurb: 'Orders, customers, products, draft orders, collections and locations of a store.', backend: { family: 'connector', connector: 'shopify' }, auth: 'token', capabilities: { browse: true, attach: false, remote_sql: false, sync: true }, fields: [], status: 'available', docs: 'https://shopify.dev/docs/apps/build/authentication-authorization/access-tokens/generate-app-access-tokens-admin' },
  { id: 'intercom', family: 'saas', label: 'Intercom', vendor: 'Intercom', blurb: 'Contacts, conversations, companies, admins, tags and teams (US, EU and AU workspaces).', backend: { family: 'connector', connector: 'intercom' }, auth: 'token', capabilities: { browse: true, attach: false, remote_sql: false, sync: true }, fields: [], status: 'available', docs: 'https://developers.intercom.com/docs/build-an-integration/learn-more/authentication' },
  { id: 'linear', family: 'saas', label: 'Linear', vendor: 'Linear', blurb: 'Issues, projects, cycles, teams and users.', backend: { family: 'connector', connector: 'linear' }, auth: 'token', capabilities: { browse: true, attach: false, remote_sql: false, sync: true }, fields: [], status: 'available', docs: 'https://linear.app/developers/graphql' },
  { id: 'pipedrive', family: 'saas', label: 'Pipedrive', vendor: 'Pipedrive', blurb: 'Deals, persons, organizations, activities, leads and products, custom fields by name.', backend: { family: 'connector', connector: 'pipedrive' }, auth: 'token', capabilities: { browse: true, attach: false, remote_sql: false, sync: true }, fields: [], status: 'available', docs: 'https://pipedrive.readme.io/docs/how-to-find-the-api-token' },
  { id: 'mailchimp', family: 'saas', label: 'Mailchimp', vendor: 'Intuit Mailchimp', blurb: 'Audience members, campaigns and campaign reports.', backend: { family: 'connector', connector: 'mailchimp' }, auth: 'token', capabilities: { browse: true, attach: false, remote_sql: false, sync: true }, fields: [], status: 'available', docs: 'https://mailchimp.com/developer/marketing/guides/quick-start/' },
];
